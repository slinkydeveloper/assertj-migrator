...
import com.slinkydeveloper.assertjmigrator.io.StringReplacer;
import com.slinkydeveloper.assertjmigrator.javaparser.AssertDiffVisitor;
...
@CommandLine.Command(name = "main", mixinStandardHelpOptions = true, version = "0.0.1", description = "AssertJ migrator")
public class Main implements Callable<Integer> {
  ...
  private void processMatch(ParseResult<CompilationUnit> parseResult, MigrationRules migrationRules,
                            Path javaFile) throws Throwable {
    // Parse the file
    ...
    importPrinterConfiguration.addOption(new DefaultConfigurationOption(DefaultPrinterConfiguration.ConfigOption.INDENTATION,
                                                                        new Indentation(Indentation.IndentType.SPACES, 0)));
